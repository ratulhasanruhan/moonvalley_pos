    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.'], function () {
                Route::get('restaurant-setup', [BusinessSettingsController::class, 'restaurantIndex'])->name('restaurant-setup');
                Route::post('update-setup', [BusinessSettingsController::class, 'restaurantSetup'])->name('update-setup');
                Route::post('delivery-fee-setup', [BusinessSettingsController::class, 'updateDeliveryFee'])->name('update-delivery-fee');
                Route::get('main-branch-setup', [BusinessSettingsController::class, 'mainBranchSetup'])->name('main-branch-setup');

                Route::get('delivery-fee-setup', [DeliveryChargeSetupController::class, 'deliveryFeeSetup'])->name('delivery-fee-setup');
                ...
                Route::post('maintenance-mode-setup', [BusinessSettingsController::class, 'maintenanceModeSetup'])->name('maintenance-mode-setup');
            ...
            Route::group(['prefix' => 'web-app', 'as' => 'web-app.', 'middleware' => ['module:system_management']], function () {
                Route::get('third-party/mail-config', [BusinessSettingsController::class, 'mailIndex'])->name('mail-config');
                Route::post('third-party/mail-config', [BusinessSettingsController::class, 'mailConfig']);
                ...
                Route::get('third-party/payment-method', [BusinessSettingsController::class, 'paymentIndex'])->name('payment-method');
                ...
                Route::post('payment-method-status', [BusinessSettingsController::class, 'paymentMethodStatus'])->name('payment-method-status');
