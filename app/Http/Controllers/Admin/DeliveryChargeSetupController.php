...
class DeliveryChargeSetupController extends Controller
{
    ...
    public function storeFreeDeliveryOverAmount(Request $request): RedirectResponse
    {
        $request->validate([
            'branch_id' => 'required',
            'free_delivery_over_status' => 'required',
            'free_delivery_over_amount' => 'required|numeric|min:0|max:9999999999',
        ]);
        ...
        $this->deliveryChargeSetup->updateOrCreate([
            'branch_id' => (integer) $request['branch_id']
                ...
                'branch_id' => (integer) $request['branch_id'],
                'free_delivery_over_status' => (integer) $request['free_delivery_over_status'],
                'free_delivery_over_amount' => $request['free_delivery_over_amount'],
            ]
        );
    ...
    public function storeFreeDeliveryOverStatus(Request $request): RedirectResponse
    {
        $request->validate([
            'branch_id' => 'required',
            'free_delivery_over_status' => 'required',
