                ...
                <div class="row justify-content-md-end mb-3 m-0" style="width: 99%">
                    <div class="col-md-10 p-0">
                        <dl class="row text-right" style="color: black!important;">
                            ...
                            <dd class="col-6">
                                {{ \App\CentralLogics\Helpers::set_symbol($subTotal+$totalTax+$addonCost+$addonTaxCost-$order['coupon_discount_amount']-$order['extra_discount']-$order['referral_discount']) }}
                            </dd>
                            ...
                            <dd class="col-6"
                                style="font-size: 20px">{{ \App\CentralLogics\Helpers::set_symbol($subTotal+$deliveryCharge+$totalTax+$addonCost-$order['coupon_discount_amount']+$addonTaxCost-$order['extra_discount']-$order['referral_discount']) }}</dd>
