                                ...
                                <tr style="font-size: .875rem; line-height: 1.6;">
                                    ...
                                    <td
                                        ...
                                        @if (count(json_decode($detail['variation'], true)) > 0)
                                            <strong><u >{{ translate('variation : ') }}</u></strong><br><br>

                                            @foreach (json_decode($detail['variation'], true) as $variation)
                                                @if (isset($variation['name']) && isset($variation['values']))
                                                    <span style="display: block; text-transform: capitalize;">
                                                        <strong style="font-weight: 500;">{{ $variation['name'] }} - </strong>
                                                    </span>
                                    ...
                                    @endif
                                        ...
                                        <div class="font-size-sm text-body"
                                            ...
                                            <span
                                                style="font-weight: bold;">{{ \App\CentralLogics\Helpers::set_symbol($detail['discount_on_product']) }}</span>
                                        </div>
                                        <br>
